...
|---|---|
| Terraform Code Style Guidelines | `refs/code-style.md` |
| Get Started with Terraform | `refs/getting-started.md` |
| Terraform MCP Server Usage Instructions | `refs/mcp-usage.md` |
| Terraform Best Practices | `refs/terraform-best-practices.md` |
