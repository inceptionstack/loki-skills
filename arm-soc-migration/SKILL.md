...
|---|---|
| Migration Constraints | `refs/constraints.md` |
| Workflow 1: Discovery and Analysis | `refs/discovery.md` |
| Workflow 3: Implementation Guidance | `refs/implementation.md` |
| Workflow 2: Migration Planning | `refs/planning.md` |
| Workflow 4: Validation and Testing | `refs/validation.md` |
