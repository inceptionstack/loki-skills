...
|---|---|
| SaaS Architecture Principles | `refs/architecture-principles.md` |
| Billing and Payments | `refs/billing-and-payments.md` |
| Implementation Patterns | `refs/implementation-patterns.md` |
| Repository Structure | `refs/repository-structure.md` |
