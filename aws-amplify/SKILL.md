...
|---|---|
| Amplify Workflow | `refs/amplify-workflow.md` |
| Phase 1: Backend | `refs/phase1-backend.md` |
| Phase 2: Sandbox Deployment | `refs/phase2-sandbox.md` |
| Phase 3: Frontend Integration & Testing | `refs/phase3-frontend.md` |
| Phase 4: Production Deployment | `refs/phase4-production.md` |
